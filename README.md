...
Текущая версия: **v2.5.4** — фикс растяжения ячеек: только ширина, высота фиксирована.
...
|--------|-----------|------|
| **v2.5.4** | Фикс: ячейки растягиваются только по ширине (убрали `aspectRatio`, высота фикс 48/38dp) | 2026-07-03 |
| **v2.5.3** | Кнопка Custom = ClassCard (общий GridCard); ячейки распределяются по ширине | 2026-07-02 |
